...
- [ ] 2. Money, balance, and decision logic in `AccommodationService`

  - [ ] 2.1 Add exact money arithmetic and balance derivation
  ...
  - [ ]* 2.2 Write property test for balance derivation
  ...
  - [ ] 2.3 Add the date-range helpers and the backdated status branch
  ...
  - [ ]* 2.4 Write property test for start date range gating and toggle reset
  ...
  - [ ]* 2.5 Write property test for initial status assignment and the completion alert
  ...
  - [ ] 2.6 Drive the GST breakup from the stay's current Total_Stay_Amount
  ...
  - [ ]* 2.7 Write property test for the GST breakup
  ...
  - [ ] 2.8 Add the action-visibility predicates
  ...
  - [ ]* 2.9 Write property test for action visibility and mutual exclusivity
  ...
  - [ ] 2.10 Add the early-checkout math
  ...
  - [ ]* 2.11 Write property test for early checkout recalculation and branch selection
  ...
  - [ ] 2.12 Add the payment-history ordering and formatting helper
  ...
  - [ ]* 2.13 Write property test for payment history ordering and completeness
...
- [ ] 3. Checkpoint - migration and pure logic
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 4. Repository layer

  - [ ] 4.1 Create `src/repositories/stayPaymentRepository.ts`
  ...
  - [ ] 4.2 Extend `src/repositories/stayRepository.ts`
  ...
  - [ ]* 4.3 Write integration tests for the two RPCs
...
- [ ] 5. Service orchestration
  ...
  - [ ] 5.1 Extend `AccommodationService.createStay`
  ...
  - [ ]* 5.2 Write property test for the onboarding advance transaction
  ...
  - [ ] 5.3 Refine `AccommodationService.extendStay`
  ...
  - [ ]* 5.4 Write property test for stay extension folding into the balance
  ...
  - [ ] 5.5 Implement `checkoutStay` and `generateFinalInvoice`
  ...
  - [ ]* 5.8 Write property test for invoice failure preserving checkout
  ...
  - [ ]* 5.9 Write property test for the ACTIVE-status gate
  ...
  - [ ]* 5.10 Write the stateful property test over the ledger
...
- [ ] 6. Checkpoint - repositories and service orchestration
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 7. Server Actions

  - [ ] 7.1 Create `src/actions/stayPaymentActions.ts`
  ...
  - [ ]* 7.2 Write property test for Record Payment validation and the ledger append
  ...
  - [ ]* 7.3 Write property test for refund validation and its ledger effect
  ...
  - [ ] 7.4 Extend `src/actions/stayActions.ts`
  ...
  - [ ] 7.5 Create `src/actions/stayInvoiceActions.ts`
  ...
  - [ ] 7.6 Extend `src/actions/accommodationOnboardingActions.ts`
  ...
  - [ ]* 7.7 Write property test for server rejection of invalid backdated payloads
  ...
  - [ ]* 7.8 Write unit tests for the non-invoiced checkout paths and the transition table
...
- [ ] 8. Final invoice branch and payment receipts

  - [ ] 8.1 Add the `ACCOMMODATION_FINAL_INVOICE` branch to `src/lib/invoices/index.ts`
  ...
  - [ ]* 8.2 Write property test for invoice figures reflecting early checkout
  ...
  - [ ]* 8.3 Write property test for invoice consolidation
  ...
  - [ ]* 8.4 Write property test for ledger preservation across invoice generation
  ...
  - [ ] 8.5 Build the receipt builder and `PaymentReceiptDocument`
  ...
  - [ ]* 8.6 Write property test for payment receipts
  ...
  - [ ]* 8.7 Write the invoice layout parity snapshot test
...
- [ ] 9. Checkpoint - actions, invoice, and receipts
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 10. Quick Onboard form — backdated toggle and payment split

  - [ ] 10.1 Add the Backdated_Stay_Toggle and the completion alert to `QuickOnboardingForm`
  ...
  - [ ] 10.2 Replace the single payment field with the total/advance split
  ...
  - [ ]* 10.3 Write unit tests for the onboarding render conditions
...
- [ ] 11. Accommodation tab surfaces

  - [ ] 11.1 Build `StayPaymentPanel`
  ...
  - [ ] 11.2 Build `RecordStayPaymentForm`
  ...
  - [ ] 11.3 Build `RecordStayRefundDialog`
  ...
  - [ ] 11.4 Build `EarlyCheckoutDialog`
  ...
  - [ ] 11.5 Build `StayCheckoutActionBar`
  ...
  - [ ] 11.6 Wire `AccommodationTab` to the full stay set
  ...
  - [ ] 11.7 Add the payment receipt route
  ...
  - [ ]* 11.8 Write unit tests for the refresh wiring
  ...
  - [ ]* 11.9 Write end-to-end integration tests for the two headline flows
