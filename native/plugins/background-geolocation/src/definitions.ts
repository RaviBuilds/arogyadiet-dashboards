/**
 * JavaScript contract for the ArogyaDiet background-geolocation fork.
 *
 * This file is a byte-for-byte port of the upstream
 * `@capacitor-community/background-geolocation@1.2.26` `definitions.d.ts`.
 * It MUST stay compatible with `src/lib/capacitor/background-geolocation-stub.ts`
 * (the web build's JS surface of truth). Do not change the shape of these types
 * as part of the native fork-and-harden work.
 */
